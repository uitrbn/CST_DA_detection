...
if __name__ == '__main__':
  ...
  print('{:d} roidb entries in pretrain dataset'.format(len(roidb_cityscapes)))
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    # del global_variable.proposal_single_list[:]
    # del global_variable.scores_single_list[:]
    ...
    for step in range(iters_per_epoch):
      ...
      rois_label, _, _, \
      _, _, _ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, 1) # should be 0
    ...
    save_name = os.path.join(output_dir, 'da_detection_pretrained_cityscapes_{}_{}_{}.pth'.format(args.session, epoch, step))
    save_checkpoint({
